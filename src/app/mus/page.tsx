...
import MusGameModal from "@/components/MusGameModal";
...
export default function MusPage() {
  ...
  function handleSaved(winnerNames: string) {
    setModalOpen(false);
    setCelebrate(winnerNames);
    setBurst((k) => k + 1);
    setRefreshKey((k) => k + 1);
  ...
  return (
    <div>
      ...
      {modalOpen && <MusGameModal onClose={() => setModalOpen(false)} onSaved={handleSaved} />}

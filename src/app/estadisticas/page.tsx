...
const PODIUM_STYLE = [
  { order: "sm:order-2", height: "h-40", medal: "🥇", ring: 84, avatar: 60 },
  { order: "sm:order-1", height: "h-32", medal: "🥈", ring: 68, avatar: 48 },
  { order: "sm:order-3", height: "h-28", medal: "🥉", ring: 60, avatar: 44 },
];

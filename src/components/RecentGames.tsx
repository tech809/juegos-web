      ...
      <ul className="space-y-4">
        {visible.map((g) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4">
                  <Link href={`/jugadores/${g.winner_id}`} className="inline-flex items-center gap-2 hover:brightness-110">
                    <div
                      className="w-9 h-9 rounded-full flex items-center justify-center text-[#f6e9c8] font-display font-bold text-sm border-2 shrink-0"
          ...
          return (
            ...
            >
              <Link href={`/jugadores/${g.winner_id}`} className="flex items-center gap-2 min-w-0 hover:brightness-110">
                <div
                ...
                <div className="min-w-0">
                  ...
                  {others.length > 0 && (
                    <p className="text-xs opacity-55 truncate">venció a {others.map((p) => p.name).join(", ")}</p>
                  )}
                </div>
              </Link>
